...
def build_parser():
    ...
    ap.add_argument("input", help="input .gro/.xyz/.pdb/.cif orthogonal system required")
    ap.add_argument("--grid", "-g", type=float, default=0.01, help="target grid spacing in nm")
    ap.add_argument("--probe", "-p", type=float, default=0.0, help="probe radius in nm")
    ...
    ap.add_argument("--threads", type=int, default=0, help="numba threads, 0=half of available threads")
    ...
    ap.add_argument("--oct-grid", type=float, default=0.001, help="minimum octree leaf size in nm")
    ...
    ap.add_argument("--debug-print", action="store_true", default=False, help="print extra debug info")
    return ap
